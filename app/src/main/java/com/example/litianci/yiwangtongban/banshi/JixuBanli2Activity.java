...
public class JixuBanli2Activity extends Activity implements View.OnClickListener, CameraPreviewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jixu_banli2);
        ...
        ArcFaceCamera.getInstance().openCamera(JixuBanli2Activity.this, surfcePreview, surfceRect);
    ...
    public void toast(final String test) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(JixuBanli2Activity.this, test, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                    Intent intent = new Intent(JixuBanli2Activity.this, BanshiShenfen3Activity.class);
...
//                    startActivity(intent);
                    ...
                    Intent intent = new Intent(JixuBanli2Activity.this, JixuBanli3Activity.class);
                    intent.putExtra("id", s3.getMsg());
                    startActivity(intent);
                    Toast.makeText(JixuBanli2Activity.this, "登录成功！", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
            ...
            case R.id.iv_home: {
                ...
                adb.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(JixuBanli2Activity.this, MainActivity.class);
