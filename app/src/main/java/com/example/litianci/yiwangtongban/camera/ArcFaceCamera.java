package com.example.litianci.yiwangtongban.camera;
...
import com.example.litianci.yiwangtongban.banshi.BanshiShenfen2Activity;
import com.example.litianci.yiwangtongban.facetrack.FaceTrackService;
import com.example.litianci.yiwangtongban.util.DrawUtils;
        ...
        try {
            ...
            camera.setPreviewCallback(new Camera.PreviewCallback() {
                ...
                public void onPreviewFrame(byte[] data, Camera camera) {
                    ...
                    //输出数据进行其他处理
                    if ((cameraPreviewListener != null && fsdkFaces.size() > 0)|| BanshiShenfen2Activity.flag==0) {
