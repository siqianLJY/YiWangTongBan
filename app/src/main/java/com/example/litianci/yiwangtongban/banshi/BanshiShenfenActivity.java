...
public class BanshiShenfenActivity extends Activity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case DeviceConnectManager.MESSAGE_CONNECTED:
                    Toast.makeText(BanshiShenfenActivity.this, "连接成功", Toast.LENGTH_SHORT).show();
                    idCardReaderThread.read();
                    break;
                case DeviceConnectManager.MESSAGE_CONNECTING_DEVICE:
                    Toast.makeText(BanshiShenfenActivity.this, "正在连接", Toast.LENGTH_SHORT).show();
                    break;
                case DeviceConnectManager.MESSAGE_CONNECTFAILED:
                    Toast.makeText(BanshiShenfenActivity.this, "连接失败", Toast.LENGTH_SHORT).show();
                    break;
                case DeviceConnectManager.MESSAGE_DISCONNECTED:
                    Toast.makeText(BanshiShenfenActivity.this, "连接关闭", Toast.LENGTH_SHORT).show();
                    break;
                case DeviceConnectManager.MESSAGE_RECONNECT_DEVICE:
                    Toast.makeText(BanshiShenfenActivity.this, "重新连接", Toast.LENGTH_SHORT).show();
                    break;
...
//                        saveBitmap(idCard.getPhoto());
                        ...
                        Intent intent = new Intent(BanshiShenfenActivity.this, BanshiShenfen2Activity.class);
...
//                    tvReaderStatus.setText(idCardReaderThread.getReadStatus());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banshi_shenfen);
            ...
            case R.id.iv_home: {
                ...
                adb.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(BanshiShenfenActivity.this, MainActivity.class);
