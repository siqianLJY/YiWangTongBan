...
public class Print2ShibieActivity extends Activity implements View.OnClickListener, CameraPreviewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_print2_shibie);
        ...
        ArcFaceCamera.getInstance().openCamera(Print2ShibieActivity.this, surfcePreview, surfceRect);
    ...
    public void toast(final String test) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Print2ShibieActivity.this, test, Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        new VolleyUtil() {
            ...
            public <T> boolean analysisData(String response) {
                ...
                if (s3 == null) {
                    ...
                    Intent intent = new Intent(Print2ShibieActivity.this, PrintMsgActivity.class);
                    ...
                    Intent intent = new Intent(Print2ShibieActivity.this, PrintResultActivity.class);
                    intent.putExtra("name", getIntent().getStringExtra("name"));
                    intent.putExtra("num", getIntent().getStringExtra("num"));
                    startActivity(intent);
                    Toast.makeText(Print2ShibieActivity.this, "登录成功！", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
            ...
            case R.id.iv_home: {
                ...
                adb.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(Print2ShibieActivity.this, MainActivity.class);
